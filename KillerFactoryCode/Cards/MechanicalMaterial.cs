...
public sealed class MechanicalMaterial : FactoryCardTemplate
{
    public override IEnumerable<CardKeyword> CanonicalKeywords => [CardKeyword.Unplayable, FactoryKeywords.Material];
    public MechanicalMaterial() : base(0, CardType.Status, CardRarity.Status, TargetType.None, false, "producer") { }
