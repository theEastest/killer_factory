...
public sealed class UniversalMaterial : FactoryCardTemplate
{
    public override IEnumerable<CardKeyword> CanonicalKeywords => [CardKeyword.Unplayable, FactoryKeywords.Material];
    public UniversalMaterial() : base(0, CardType.Status, CardRarity.Status, TargetType.None, false, "producer") { }
